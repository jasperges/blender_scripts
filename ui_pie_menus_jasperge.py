...
bl_info = {
    "name": "Pie Menus Jasperge",
    "author": "Antony Riakiotakis, Sebastian Koenig, Jasper van Nieuwenhuizen",
    "version": (1, 0, 2),
    "blender": (2, 71, 4),
    "description": "Enable official Pie Menus in Blender with some personal tweaks",
